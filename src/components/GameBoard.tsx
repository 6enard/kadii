...
export const GameBoard: React.FC<GameBoardProps> = ({ gameState, onDrawCard }) => {
  ...
  return (
    <div className="relative">
      {/* Compact Game Table */}
      <div className="bg-gradient-to-br from-emerald-900/30 to-emerald-800/30 backdrop-blur-sm rounded-xl border border-emerald-500/20 p-4 shadow-xl">
        <div className="flex items-center justify-between">
          {/* Draw Pile */}
          <div className="flex flex-col items-center space-y-2">
            <div
              className="w-14 h-20 bg-gradient-to-br from-slate-800 to-slate-900 rounded-lg border-2 border-emerald-400/50 
                         cursor-pointer hover:border-emerald-400 transition-all duration-300
                         flex items-center justify-center transform hover:scale-105 relative overflow-hidden group shadow-lg"
              onClick={onDrawCard}
            >
              {/* Animated background */}
              ...
              <div className="relative z-10 flex flex-col items-center justify-center text-emerald-400">
                <Shuffle size={14} className="mb-1 group-hover:rotate-180 transition-transform duration-500" />
          ...
          <div className="flex-1 mx-4">
            <div className="bg-black/30 backdrop-blur-md rounded-lg border border-white/20 p-3 text-center">
              ...
              <div className="space-y-1">
                {gameState.drawStack > 0 && (
                  <div className="bg-red-500/20 border border-red-500/30 rounded-lg p-1">
                ...
                {gameState.selectedSuit && (
                  <div className="bg-yellow-500/20 border border-yellow-500/30 rounded-lg p-1">
                ...
                {gameState.pendingQuestion && (
                  <div className="bg-orange-500/20 border border-orange-500/30 rounded-lg p-1">
            ...
            <div className="relative">
              ...
              <div className="relative w-14 h-20">
                {recentCards.map((card, index) => {
                  ...
                  const rotation = (index - 1) * 2; // Spread cards with slight rotation
                  const xOffset = (index - 1) * 1; // Slight horizontal offset
